...
$(function () {
    ...
    $('.js_file2').on('change', function (event) {
        let then = this
        var files = event.target.files;
        // 如果没有选中文件，直接返回
    ...
    $('.js_file3').on('change', function (event) {
        let then = this
        var files = event.target.files;
        // 如果没有选中文件，直接返回
    ...
    $('.js_file4').on('change', function (event) {
        let then = this
        var files = event.target.files;
        // 如果没有选中文件，直接返回
    ...
    $('.js_file5').on('change', function (event) {
        let then = this
        var files = event.target.files;
        // 如果没有选中文件，直接返回
    ...
    $('.js_file6').on('change', function (event) {
        let then = this
        var files = event.target.files;
        // 如果没有选中文件，直接返回
