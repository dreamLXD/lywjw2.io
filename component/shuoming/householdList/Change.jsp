...
<body>
    <section>
        <div class="list">
            <a onclick="jumpInstructions('ChangeSurnameInstructions');" class="fixclear">
                <p>变更姓氏</p>
                <span class="green">在线预审</span>
            </a>
        </div>
        <div class="list">
            <a onclick="jumpInstructions('ChangeNameInstructions');" class="fixclear">
                <p>变更名字</p>
                <span class="green">在线预审</span>
            </a>
        </div>
        <div class="list">
            <a onclick="jumpInstructions('ChangeNationInstructions');" class="fixclear">
                <p>变更更正民族</p>
                <span class="green">在线预审</span>
            </a>
        </div>
        <div class="list">
            <a onclick="jumpInstructions('ChangeOtherInstructions');" class="fixclear">
                <p>服务处所、学历、婚姻状况等</p>
                <span class="green">在线预审</span>
            </a>
        </div>
