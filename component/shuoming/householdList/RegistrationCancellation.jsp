...
<body>
    <section>
        <div class="list">
            <a onclick="jumpInstructions('DeathCancellationInstructions');" class="fixclear">
                <p>死亡注销</p>
                <span class="blue">全程网办</span>
            </a>
        </div>
        <div class="list">
            <a onclick="jumpInstructions('ArmyCancellationInstructions');" class="fixclear">
                <p>参军入伍注销</p>
                <span class="blue">全程网办</span>
            </a>
        </div>
        <div class="list">
            <a onclick="jumpInstructions('AbroadCancellationInstructions');" class="fixclear">
                <p>出国（境）定居注销</p>
                <span class="blue">全程网办</span>
            </a>
        </div>
