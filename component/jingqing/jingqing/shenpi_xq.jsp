...
.weui-cell__bd .weui-cell:nth-of-type(1){
	padding-bottom: 10px
}
.weui-cell__ft {
	color: #666;
...
<body>
	...
	<div class="weui-tab">
		<div class="weui-navbar">
			<a class="weui-navbar__item weui-bar__item--on" href="#tab1">报警信息</a> 
                        <a class="weui-navbar__item" href="#tab2"> 处警单 </a>
		</div>
			...
			<div id="tab2" class="weui-tab__bd-item">
				<form action="#" method="post" id='signupForm'>
					<div class="weui-cells">
						...
						<div class="weui-cell"  id = "${movies.id}">
							<video controls src="<%=basePath%>upload/${movies.spname}"  >
							<div class = "fgc"></div>
							</video>
						</div>
						</c:forEach>	
					...
					<div class="weui-cells">
						...
						<div class="weui-cell">
							...
							<ul>
								...
								<!--	<li  class = "weui-upload_file" style="background-image:url(${photoes.photoes})"> !-->
									<div class = "fgc"></div>
									</li>
								</c:forEach>
							</ul>
							...
							<div class="weui-cell__bd">
								<div class="weui-cell">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="afcslb" id="afcsType" onclick="two()"
											type="text" data-values="${sp_alarmlist.afcslb_id}" value="${sp_alarmlist.afcslb}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="afcslx" id="afType"
											type="text" data-values="${sp_alarmlist.afcslx_id}" value="${sp_alarmlist.afcslx}">
									</div>
								</div>
								...
								<div class="weui-cell block">
									...
									<div class="weui-cell__ft ">
									<textarea class="weui-input" name="afdlwz" 
								...
								<div class="weui-cell block">
									...
									<div class="weui-cell__ft ">
									<textarea class="weui-input" name="xcclqk" 
								...
								<div class="weui-cell">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="swrs" type="text"
											value="${sp_alarmlist.swrs}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="ssrs" type="text"
											value="${sp_alarmlist.ssrs}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="zjjjss" type="text"
											value="${sp_alarmlist.zjjjss}">
									</div>
								</div>
								...
								<div class="weui-cell">
									...
									<div class="weui-cell__ft ">
										<input id="timeThree" name="ddxcsj" class="weui-input bdr_none"  disabled type="text" 
											value="${sp_alarmlist.ddxcsj}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input id="timeOne" name="afsj" class="weui-input" type="text"
											value="${sp_alarmlist.afsj}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input id="timeTwo" class="weui-input" name="afjssj"
											type="text" value="${sp_alarmlist.afjssj}">
								...
								<div class="weui-cell">
									...
									<div class="weui-cell__ft ">
										<input id="yesNo" class="weui-input" name="xczj" type="text"
										data-values="${sp_alarmlist.xczj_id}"  value="${sp_alarmlist.xczj}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="spfs" type="text"
											value="${sp_alarmlist.spfs}">
								...
								<div class="weui-cell">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="zpfs" type="text"
											value="${sp_alarmlist.zpfs}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="zwfs" type="text"
											value="${sp_alarmlist.zwfs}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input class="weui-input" name="cdjyxm" type="text"
											value="${sp_alarmlist.cdjyxm}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input id="category" class="weui-input" name="jqlbdm"  onclick="one()"
											type="text" data-values="${sp_alarmlist.jqlbdm_id}" value="${sp_alarmlist.jqlbdm}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input id="jqType" class="weui-input" name="jqlxdm"
											type="text" data-values="${sp_alarmlist.jqlxdm_id}" value="${sp_alarmlist.jqlxdm}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input id="particular" class="weui-input" name="jqxldm"
											type="text" data-values="${sp_alarmlist.jqxldm_id}" value="${sp_alarmlist.jqxldm}">
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__bd">
									...
									<div class="weui-cell__ft ">
										<input id="jqcljg" class="weui-input" name="jqcljg"
											type="text" value="${sp_alarmlist.jqcljg}">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="weui-cell">
							<div class="weui-cell__bd">
								...
								<div class="weui-cell block">
                                    ...
                                    <div class="weui-cell__ft bdr_none">
										<textarea name="" id="" class="weui-input"  style="border:1px solid #ccc ">${party.others}</textarea>
									</div>
								</div>
								...
								<div class="weui-cell block">
										...
										<div class="weui-cell__ft  bdr_none">${party.photoes}</div>
										<ul>
						...
						<div class="weui-cell">
							<div class="weui-cell__bd">
								...
								<div class="weui-cell block">
                                    ...
                                    <div class="weui-cell__ft bdr_none">
											<textarea name="" class="weui-input" style="border:1px solid #ccc ">${eyewitness.others}</textarea>
										</div>
								</div>
								...
								<div class="weui-cell block">
										...
										<div class="weui-cell__ft bdr_none" >${eyewitness.photoes}</div>
										<ul>
	...
	<footer>
		<div class="weui-form-preview__ft">
			<button type="submit"
				class="weui-form-preview__btn weui-form-preview__btn_primary blue_color">审核通过</button>
		</div>
	</footer>

</body>
<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/jingqing/js/shenpi_xp.js"></script>
