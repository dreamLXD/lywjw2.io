...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/ChangeNation.js"></script>
...
<!-- 					<div class="weui-cell">
					...
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">
							<input class="weui-input"  id="bghnr" required name="bghnr" placeholder="请选择变更后民族">
						</div>
					</div>
			...
			<div class="weui-cells style2 weui-cells_form">
				...
				<div class="imgshow imgshow_base3">
					...
					<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/bggzmz/bggzmz.jpg" alt="">
