...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/SecCollegeGraduate.js"></script>
				...
				<div class="imgshow imgshow_base1">
					<div>
						...
						<p class="zhushi">
							毕业证
							<br><br>
							<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/byz/byzs.jpg" alt="">
						</p>
						<button>确定</button>
					</div>
				</div>
				...
				<div class="imgshow imgshow_base2">
					<div>
						...
						<p class="zhushi">
							就业报到证
							<br><br>
							<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/bdz/bdzfm.jpg" alt="">
							<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/bdz/bdzzm.jpg" alt="">
						</p>
						<button>确定</button>
					</div>
				</div>
