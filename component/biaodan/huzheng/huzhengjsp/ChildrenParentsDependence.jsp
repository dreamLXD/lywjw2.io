...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/ChildrenParentsDependence.js"></script>
			...
			<div class="weui-cells  style1  weui-cells_form">
				...
				<div class="imgshow imgshow_base4">
					<div>
						...
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/lhxys/lhxys.jpg" alt="">
