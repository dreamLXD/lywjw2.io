...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/AdoptionMigration.js"></script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" name="syrxm" required placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">公民身份证号码:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" required name="syrsfz" placeholder="请输入身份证号码">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">联系电话:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" required name="syrtel" placeholder="请输入号码">
					</div>
				</div>
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" required name="bsyrxm" placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">被收养人身份证号码:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" required name="bsyrsfz" placeholder="请输入身份证号码">
					</div>
				</div>
			...
			<div class="weui-cells  weui-cells_form">
				...
				<div class="imgshow imgshow_base2">
					<div>
						...
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/sydj/syz.jpg" alt="">
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/sydj/syz1.jpg" alt="">
							<br><br>
