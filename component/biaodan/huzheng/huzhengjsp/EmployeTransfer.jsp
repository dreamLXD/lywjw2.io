...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/EmployeTransfer.js"></script>
...
<!-- 				<div class="weui-cell">
				...
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">联系电话:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" required name="sbrlxdh" placeholder="请输入号码">
					</div>
				</div> -->
					...
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">组织、人社部门出具的调动函或录用通知书
										</div>
				...
				<div class="imgshow imgshow_base3">
					<div>
						...
						<p class="zhushi">
							...
							<br><br>
							<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/zzrsbmcjdddh/zzrsbmcjdddh.jpg" alt="">
						</p>
						<button>确定</button>
					</div>
				</div>
