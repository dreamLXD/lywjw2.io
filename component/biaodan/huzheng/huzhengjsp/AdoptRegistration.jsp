...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/AdoptRegistration.js"></script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" id="syname" name="syname" required placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">公民身份证号码:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input"  id="sysfz" required name="sysfz" placeholder="请输入身份证">
					</div>
				</div>
			</div>
			<h1>被收养人信息</h1>
			...
			<div class="weui-cells weui-cells_form">
							...
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">收养登记证或者事实收养公证书</div>
				...
				<div class="imgshow imgshow_base1">
					<div>
						...
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/sydj/syz.jpg" alt="">
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/sydj/syz1.jpg" alt="">
							<br><br>
