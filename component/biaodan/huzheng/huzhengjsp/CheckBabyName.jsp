...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/CheckBabyName.js"></script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" name="yename" required placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">出生日期:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" id="time" required name="yecsrq" placeholder="请选择出生日期">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">性别:</label></div>
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" id="Nation" required name="yemz" placeholder="请选择民族">
					</div>
				</div>
			</div>
