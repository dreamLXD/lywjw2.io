...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/FirCollegRecruit.js"></script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" id="idpcs" required name="blpcs" placeholder="请选择派出所" readonlys>
					</div>
				</div>
			</div>
				...
				<div class="imgshow imgshow_base3">
					<div>
						...
						<p class="zhushi">
							请上传录取通知书，照片大小不超过5兆。
							<br><br>
							<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/lqtzs/lqtzs.jpg" alt="">
						</p>
						<button>确定</button>
					</div>
				</div>
