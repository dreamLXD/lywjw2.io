...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/ChangeID.js"></script>
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="imgshow imgshow_base1">
					<div>
						...
						<p class="zhushi">
							本人或监护人申请：第1页...
							<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/sfzbg/sfzbg.jpg" alt="">
						</p>
						<button>确定</button>
					</div>
				</div>
