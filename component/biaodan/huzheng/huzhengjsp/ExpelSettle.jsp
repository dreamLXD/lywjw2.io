...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/ExpelSettle.js"></script>
			...
			<div class="weui-cells  weui-cells_form">
					...
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">军人公民身份号码登记表</div>
				...
				<div class="imgshow imgshow_base2">
					<div>
						...
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/jrhmdjb/hmdjb.jpg" alt="">
						<button>确定</button>
					</div>
				</div>
			</div>
