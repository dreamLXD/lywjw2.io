...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/FirCollegeGraduate.js"></script>
...
<!-- 				</div> -->
				...
				<div class="imgshow imgshow_base2">
					<div>
						...
						<p class="zhushi">
							请上传就业报到证，照片大小不超过5兆。
							<br><br>
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/bdz/bdzfm.jpg" alt="">
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/bdz/bdzzm.jpg" alt="">
						</p>
						<button>确定</button>
					</div>
				</div>
			...
			<div class="weui-cells style2 weui-cells_form">
				...
				<div class="imgshow imgshow_base3">
					...
					<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/hkqyz/hkqyz.jpg" alt="">
