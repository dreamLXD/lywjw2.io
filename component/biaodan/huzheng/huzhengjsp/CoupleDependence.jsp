...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/CoupleDependence.js"></script>
			...
			<div class="weui-cells   weui-cells_form">
				...
				<div class="imgshow imgshow_base3">
					<div>
						...
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/jhz/jhz3.jpg" alt="">
						<button>确定</button>
					</div>
				</div>
			</div>
