...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/RemoveCard.js"></script>
...
<!-- 				</div> -->
	...
	<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/zqz/zqz.jpg" alt="">
