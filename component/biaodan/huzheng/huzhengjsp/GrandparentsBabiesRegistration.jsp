...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/GrandparentsBabiesRegistration.js">
	</script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" required name="mqsfz" placeholder="请输入身份证">
					</div>
				</div>
			</div>
			<h1>新生儿信息</h1>
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">性别：</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" name="yesex" id="sex" placeholder="请选择性别">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">出生日期：</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" name="yecsrq" data-toggle='date' id="time" required
							placeholder="请选择日期">
					</div>
				</div>
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" name="yeysqrgx" id="resp" required placeholder="请选择关系">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">民族：</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" name="yemz" id="Nation" required placeholder="请选择民族">
					</div>
				</div>
			</div>
			<h1>上传材料</h1>
					...
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">父母及子女末次入境待用的中国护照或旅行证</div>
										<i class="weui-icon-warn weui-icon_msg-primary imgwarn img_i_base10"></i>
									</div>
									<div class="weui_uploader_bd">
										<ul class="weui_uploader_files ten">
										</ul>
										<div class="weui_uploader_input_wrp">
											<input class="weui_uploader_input js_file10" type="file" name="img"
												accept="image/*" multiple></div>
									</div>
								</div>
							</div>
