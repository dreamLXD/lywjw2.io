...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/ChangeSurname.js"></script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">姓名:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" type="text"  name="sqrxm"  value="${jbxx.zsxm }" required
							placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">公民身份证号码:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" required name="sqrsfz"  value="${jbxx.sfzh }" placeholder="请输入公民身份证号码">
					</div>
				</div>
...
<!-- 				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">姓名:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" name="sqrxm" required placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">公民身份证号码:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" required name="sqrsfz" placeholder="请输入身份证号码">
					</div>
				</div> -->
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input"  id="bghnr" required name="bghnr" placeholder="请输入变更姓氏">
					</div>
				</div>
             </div>
