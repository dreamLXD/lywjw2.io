...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/CivilServiceSettle.js"></script>
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="imgshow imgshow_base1">
					<div>
						...
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/lhjsx/lhjsx.jpg" alt="">
						<button>确定</button>
					</div>
				</div>
			</div>
