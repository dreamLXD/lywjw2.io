...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/MarriageBabiesRegistration.js">
	</script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" id="resp" name="yeysqrgx" required placeholder="请选择关系">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">民族：</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" id="Nation" name="yemz" required placeholder="请输入民族">
					</div>
				</div>
			</div>
			<h1>上传材料</h1>
