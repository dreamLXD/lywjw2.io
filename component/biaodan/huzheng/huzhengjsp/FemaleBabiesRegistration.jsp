...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/FemaleBabiesRegistration.js"></script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" name="fqname" required placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">父亲公民身份证号码：</label></div>
					<div class="weui-cell__bd">
				...
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">母亲公民身份证号码：</label></div>
					<div class="weui-cell__bd">
			...
			<div class="weui-cells weui-cells_form">
							...
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">军官证或士官证</div>
				...
				<div class="imgshow imgshow_base1">
					<div>
						...
						<p class="zhushi">
							请上传军官证或士官证，照片大小不超过5兆。
						</p>
					<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/jgz/jgz.jpg" alt="">
					<button>确定</button>
					</div>
				</div>
			</div>
					...
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">单位证明</div>
					...
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">亲属关系证明</div>
