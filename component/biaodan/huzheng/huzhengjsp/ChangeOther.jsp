...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/js/ChangeOther.js"></script>
...
<!-- 				</div> -->
				...
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">姓名:</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" type="text"  name="sqrxm" required value="${jbxx.zsxm }" required
							placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
...
<!-- 					<div class="weui-cell">
					...
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">
							<input class="weui-input" required name="bghnr" placeholder="请输入变更后内容">
						</div>
					</div>
			...
			<div class="weui-cells style2 weui-cells_form">
				...
				<div class="imgshow imgshow_base3">
					...
					<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/byz/byzs.jpg" alt="">
				<button>确定</button>
					</div>
				</div>
			</div>
