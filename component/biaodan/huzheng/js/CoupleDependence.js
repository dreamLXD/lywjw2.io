$(function () {
    ...
    $('.style2').css('display', 'none')
            ...
            $("#style").select({
                ...
                items: [{
                        title: "随迁未成年子女",
                        value: "44e0c30fb0cb43b5a5ef5716c8b4acc9",
                    },
                    {
                        title: "再婚携带未成年子女",
                        value: "ff471cc31f2342bfa4cea646859685df",
                    }
                ],
                onClose: function () {
                    $('.style1').css('display', 'none')
                    ...
                    $('.four').html('')
                    $('.five').html('')
                    if ($('#style').data('values') == '44e0c30fb0cb43b5a5ef5716c8b4acc9') {
                        $('.style1').css('display', 'block')
                    } else if ($('#style').data('values') == 'ff471cc31f2342bfa4cea646859685df') {
...
$(function () {
    ...
    $('footer button').on('click', function (e) {
        ...
        filestr('arr_file3', '.three', 'threefile', 'a69c7610096e401ca54e03e9adbf94ae');
        filestr('arr_file4', '.four', 'fourfile', 'daea09e9ab2c469ca1391c4cd0f7b66e');
        filestr('arr_file5', '.five', 'fivefile', '73672ee6df1b4982bfd204e31413d239');

        console.log(obj);

        obj.blyw = '27988ce5b1414d6296f9fa1e1b5b7a9d';



        if (obj.bltype === '44e0c30fb0cb43b5a5ef5716c8b4acc9') {
            img_reg(obj, ['onefile', 'twofile', 'threefile', 'fourfile'])
        } else if (obj.bltype === 'ff471cc31f2342bfa4cea646859685df') {
