...
$(function () {
	...
	$('footer button').on('click', function (e) {
		...
		filestr('arr_file1', '.one', 'onefile', 'd6fb215eef974785948a28f4a7508969')
		filestr('arr_file2', '.two', 'twofile', 'd646786c513d40e18ea5379ba0b75eb2')
		filestr('arr_file3', '.three', 'threefile', '09f86e6af71c48609e30f167e8b871e1')

		console.log(obj)

		obj.blyw = 'bc397e343779404fa7e600103a5785e6';
