$(function() {
    ...
    $("#style").select({
        ...
        items: [{
                title: "现役新生入伍需要",
                value: "a192a29d746a4c3386f1c572b477559b",
            },
            {
                title: "应届毕业生入伍",
                value: "379f3de935844d828f58a9886f55b683",
            }
        ],
        onClose: function() {
            $('.style1').css('display', 'none')
            ...
            $('.three').html('')
            $('.four').html('')
            if ($('#style').data('values') == 'a192a29d746a4c3386f1c572b477559b') {
                $('.style1').css('display', 'block')
            } else if ($('#style').data('values') == '379f3de935844d828f58a9886f55b683') {
...
$(function() {
    ...
    $('footer button').on('click', function(e) {
        ...
        filestr('arr_file1', '.one', 'onefile', '504d4bbc393d415aaaa813fff38d550a')
        filestr('arr_file2', '.two', 'twofile', 'f4e05d3d86fb49af9202dc7798414d07')
        filestr('arr_file3', '.three', 'threefile', '48fb29abf5374017a1650fedb110ded2')
        filestr('arr_file4', '.four', 'fourfile', '35d514c81bac44b29151ca1f63fc0608')
        // filestr('arr_file4', '.four', 'fourfile')
        // filestr('arr_file5', '.five', 'fivefile')

        console.log(obj)

        obj.blyw = '167d398b2b5a428f891dd0c39b25f54d';

        if (obj.bltype === 'a192a29d746a4c3386f1c572b477559b') {
            img_reg(obj, ['onefile', 'twofile', 'threefile'])
        } else if (obj.bltype === '379f3de935844d828f58a9886f55b683') {
