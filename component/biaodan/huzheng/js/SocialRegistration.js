...
$(function () {
    ...
    $('footer button').on('click', function (e) {
        ...
        filestr('arr_file1', '.one', 'onefile', 'a02db3ddf0eb4b6eb35432af76bf3f14')
        filestr('arr_file2', '.two', 'twofile', 'f7c132fd2cb0484ba140c96f522a0da5')
        filestr('arr_file3', '.three', 'threefile', '938f8833e51a4183a0b424b618dc19eb')
        filestr('arr_file4', '.four', 'fourfile', '1b736d5515224fde97a6534f1a7a7793')
        filestr('arr_file5', '.five', 'fivefile', 'cb05553c39714fc283607954e90d3927')
        filestr('arr_file6', '.six', 'sixfile', '7f0f7d4eeddd4dfb82b37b4c11d87a6b')

        console.log(obj)

        obj.blyw = '16e81f1e98f44ea0a91215bbe67f74a7';
