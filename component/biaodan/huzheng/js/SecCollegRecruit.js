...
$(function() {
    ...
    $('footer button').on('click', function(e) {
        ...
        filestr('arr_file1', '.one', 'onefile', 'c50b3929251544d6a800c37b64c98f60')
        filestr('arr_file2', '.two', 'twofile', '09f86e6af71c48609e30f167e8b871e1')

        console.log(obj)

        obj.blyw = 'ec2656c72d2a44c2920afe9612a21299';
