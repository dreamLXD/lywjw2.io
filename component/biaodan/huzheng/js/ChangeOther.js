$(function () {
	...
	$('.style3').css('display', 'none')
				...
				$("#style").select({
					...
					items: [{
						title: "变更服务处所",
						value: "58bdef09757f4bcf88e5a1cb6709927d",
					},
					{
						title: "变更学历",
						value: "2cf4df06ac124411b6ac5d0564541133",
					},
					{
						title: "变更婚姻状况",
						value: "afe6377a6c7844f5bd27a3f2fd05b502",
					}],
					onClose: function () {
						$('.style1').css('display', 'none')
						$('.style2').css('display', 'none')
						...
						if ($('#style').data('values') == '58bdef09757f4bcf88e5a1cb6709927d') {
							$('.style1').css('display', 'block')
						} else if ($('#style').data('values') == '2cf4df06ac124411b6ac5d0564541133') {
...
$(function () {
	...
	$('footer button').on('click', function (e) {
		...
		filestr('arr_file2', '.two', 'twofile', '3aecda8c0f32477e8a0a4499f893db7e')
		filestr('arr_file3', '.three', 'threefile','d6fb215eef974785948a28f4a7508969')
	    filestr('arr_file4', '.four', 'fourfile','9a9bf0b943024269a599bc838eedafb8')
		// filestr('arr_file5', '.five', 'fivefile')
		console.log(obj)

		obj.blyw = 'f9ae4532084a4dcab655c56b40c1d35f';

        if (obj.bltype === '58bdef09757f4bcf88e5a1cb6709927d') {
            img_reg(obj, ['onefile', 'twofile'])
        } else if (obj.bltype === '2cf4df06ac124411b6ac5d0564541133') {
            img_reg(obj, ['onefile','threefile'])
        } else if (obj.bltype === 'afe6377a6c7844f5bd27a3f2fd05b502') {
