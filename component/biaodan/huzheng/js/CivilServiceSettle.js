...
$(function () {
    ...
    $('footer button').on('click', function (e) {
        ...
        arr.forEach((item, k) => {
            ...
            if (item.name == 'tkr_yhzgx') {
                obj[item.name] = $('#tkr_yhzgx').data('values')
            }
        ...
        filestr('arr_file2', '.two', 'twofile', '584252eda9f3492292f227d1d22331a7')
        ...
        obj.blyw = 'f800a1a04d884de78fea1f4c17661de0';
