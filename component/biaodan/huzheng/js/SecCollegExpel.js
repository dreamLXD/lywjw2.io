...
$(function () {
	...
	$('footer button').on('click', function (e) {
		...
		filestr('arr_file1', '.one', 'onefile', '2fb137e1e06347a3936a5bd6209e01b3')
		filestr('arr_file2', '.two', 'twofile', '9eee5d54aea94e289a55f769107ef540')

		console.log(obj)

		obj.blyw = '916b50e168e0442d8ab0ed6e25693cf3';
