...
$(function () {
    ...
    $('footer button').on('click', function (e) {
        ...
        filestr('arr_file1', '.one', 'onefile', '584252eda9f3492292f227d1d22331a7')
        filestr('arr_file2', '.two', 'twofile', 'f4e05d3d86fb49af9202dc7798414d07')
        filestr('arr_file3', '.three', 'threefile', '6ca24126a061463c82024190bc2a96c0') //居民身份证或军人公民身份号码登记表
        filestr('arr_file4', '.four', 'fourfile', 'ba2ec82fbac344c3a0cb7e01b31f839e')
        ...
        obj.blyw = '5302de55932d4e6bbe689cde9cda0683';
