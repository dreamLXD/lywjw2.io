...
$(function () {
    ...
    $('.style3').css('display', 'none')
            ...
            $("#style").select({
                ...
                items: [{
                        title: "港澳居民回内地定居落户",
                        value: "27caad6bd90744fdbe60de3cc54a3d10",
                    },
                    {
                        title: "台湾居民定居大陆落户",
                        value: "dd25c403d57340c18e862bcf4d8ce968",
                    },
                    {
                        title: "华侨回国定居",
                        value: "72e72d0d616d4848bbb71846077525b4",
                    }
                ],
                onClose: function () {
                    $('.style1').css('display', 'none')
                    ...
                    $('.five').html('')
                    $('.six').html('')
                    if ($('#style').data('values') == '27caad6bd90744fdbe60de3cc54a3d10') {
                        $('.style1').css('display', 'block')
                    } else if ($('#style').data('values') == 'dd25c403d57340c18e862bcf4d8ce968') {
...
$(function () {
    ...
    var urlval = url.split("val=")[1];
        ...
        arr.forEach((item, k) => {
            ...
            if (item.name == 'blfenju') {
                obj[item.name] = $('#blfenju').data('values')
            }
        ...
        window.onload = function () {
            if (urlval == '1') {
                filestr('arr_file1', '.one', 'onefile', '2352399efbf04e1f94ccfcd9a54a9596')
            } else if (urlval == '2') {
                filestr('arr_file1', '.one', 'onefile', 'c6c3d461be5244deb5e4c59a5e2542fa')
            }
        }


        filestr('arr_file1', '.one','onefile', '2352399efbf04e1f94ccfcd9a54a9596')
        filestr('arr_file2', '.two', 'twofile', '5b11aada9ba946b5a4258bbc31f835b5')
        filestr('arr_file3', '.three', 'threefile', '08fc3c0d127649fd9d35a602b0e70ad0')
        filestr('arr_file4' ,'.four', 'fourfile', 'ec2c55adc99549cb8c9f0482e18c15c5')
        filestr('arr_file5', '.five', 'fivefile', 'd3836c1bc4904bad8f918a7fe2ede708')
        filestr('arr_file6', '.six', 'sixfile', 'c344e9df3ef146fe8dc4e7ba44bb1330')
        ...
        obj.blyw = '52199d5f4c1444babfa28b8bad0a27ed';



        if (obj.bltype === '27caad6bd90744fdbe60de3cc54a3d10') {
            img_reg(obj, ['onefile', 'twofile'])
        } else if (obj.bltype === 'dd25c403d57340c18e862bcf4d8ce968') {
            img_reg(obj, ['onefile', 'threefile', 'fourfile'])
        } else if (obj.bltype === '72e72d0d616d4848bbb71846077525b4') {
            img_reg(obj, ['onefile', 'fivefile', 'sixfile'])
        }
