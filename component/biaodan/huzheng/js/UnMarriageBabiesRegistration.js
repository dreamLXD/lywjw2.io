    ...
    $('.imgshow').on('click',function(){
		$(this).css('display','none')
            ...
            $("#style").select({
                ...
                items: [{
                    title: "跟随母亲落户",
                    value: "51072ed58dc0425fb916d8990c9a52a7",
                }, {
                    title: "跟随父亲落户",
                    value: "9a03fd84ba9d42bd84441e4272ea0b1b",
                }],
                onClose: function () {
                    ...
                    $('.four').html('')
                    $('.five').html('')
                    if ($('#style').data('values') == '51072ed58dc0425fb916d8990c9a52a7') {
                        $('.style2').css('display', 'block')
                    } else if ($('#style').data('values') == '9a03fd84ba9d42bd84441e4272ea0b1b') {
...
$(function () {
 ...
 $('form').submit()
        ...
        filestr('arr_file4', '.four', 'fourfile', '57f105d08090403080936f371b3c79c2')
        filestr('arr_file5', '.five', 'fivefile', 'b07bfec1c44447e1803454238a2e9340')
        console.log(obj)

        obj.blyw = '4ab1d2690e69441ca87fea43271f3a40';

        if (obj.bltype === '51072ed58dc0425fb916d8990c9a52a7') {
            img_reg(obj, ['onefile', 'twofile', 'threefile', 'fourfile'])
        } else if (obj.bltype === '9a03fd84ba9d42bd84441e4272ea0b1b') {
