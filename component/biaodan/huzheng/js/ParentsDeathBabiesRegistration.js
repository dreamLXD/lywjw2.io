...
$(function () {
    ...
    $('footer button').on('click', function (e) {
        ...
        filestr('arr_file4', '.four', 'fourfile', '441f520ab5ac4c728cbf50dabf5c5f72')
        filestr('arr_file5', '.five', 'fivefile', '62f8e9f7a6e247d0bd706969fe9a2338')
        filestr('arr_file6', '.six', 'sixfile', 'fa27ea8ecb9a4b84a9dea58a83a8c72c')

        console.log(obj)

        obj.blyw = '8113b6bc2e1141948fd7544cc5e9e216';
