...
<head>
	...
	<script
		src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/ArmyCancellation.js"></script>
					...
					<section>
						...
						<div class="weui-cells weui-cells_form">
							...
							<div class="weui-cell">
								<div class="weui-cell__hd"><label class="weui-label">公民身份证号码:</label></div>
								<div class="weui-cell__bd">
									<input class="weui-input" required name="swrysfz" value="${jbxx.swrysfz }"
							...
							<div class="weui-cell">
								...
								<div class="weui-cell__bd">
									<input class="weui-input" id="ysqrgx" required name="ysqrgx" value="${jbxx.ysqrgx }"
										placeholder="请选择关系">
								</div>
							</div>
						</div>
						...
						<c:forEach items="${photoes}" var="photoes">
							<c:if test="${photoes.type_id == '504d4bbc393d415aaaa813fff38d550a' }">
								<div class="weui-cells weui-cells_form">
									<div class="container">
									...
									<div class="imgshow imgshow_base1">
										<div>
											...
											<p class="zhushi">
												请上传应征公民入伍通知书或军校录取通知书或军（士）官证。注意照片大小不超过5兆
												<br><br>
						...
						<c:forEach items="${photoes}" var="photoes">
							<c:if test="${photoes.type_id == 'f4e05d3d86fb49af9202dc7798414d07' }">
								<div class="weui-cells style1  style2  weui-cells_form">
									<div class="container">
										<div class="weui_cells weui_cells_form">
											<div class="weui_cell">
												<div class="weui_cell_bd weui_cell_primary">
						...
						<c:forEach items="${photoes}" var="photoes">
							<c:if test="${photoes.type_id == '48fb29abf5374017a1650fedb110ded2' }">
								<div class="weui-cells style2 style1  weui-cells_form">
									<div class="container">
										<div class="weui_cells weui_cells_form">
											<div class="weui_cell">
												<div class="weui_cell_bd weui_cell_primary">
						...
						<!--户口迁移证-->
						<c:if test="${jbxx.bltype_id =='379f3de935844d828f58a9886f55b683'}">
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == '35d514c81bac44b29151ca1f63fc0608' }">
