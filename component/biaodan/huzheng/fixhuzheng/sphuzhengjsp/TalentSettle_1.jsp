            ...
            onChange:function () {
                if( $('#zhengming').data('values') == '1'){
                   $('a').on('click',function (e) {
                       e.preventDefault();
                       window.location.href="<%=basePath%>wx/jumpHousehold/jumpTalentSettle_2?openid=${jbxx.openid}&PageName=TalentSettle_2&val=1"
                   })
                }else if($('#zhengming').data('values') == '2'){
                    $('a').on('click',function (e) {
                        e.preventDefault();
                        window.location.href="<%=basePath%>wx/jumpHousehold/jumpTalentSettle_2?openid=${jbxx.openid}&PageName=TalentSettle_2&val=2"
                    })
                }
            }
        })
