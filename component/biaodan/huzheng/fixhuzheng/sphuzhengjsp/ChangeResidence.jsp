...
<head>
	...
	<script
		src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/ChangeResidence.js"></script>
								...
								<div class="weui-cells weui-cells_form">
									...
									<div class="imgshow imgshow_base1">
										<div>
											...
											<p class="zhushi">
												请上传本人或监护人申请，暂无示例图片，注意照片大小不超过5兆。
											</p>
											<button>确定</button>
										</div>
									</div>
