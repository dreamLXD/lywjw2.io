...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/SecCollegRecruit.js"></script>
                            ...
                            <div class="weui-cell">
                                ...
                                <div class="weui-cell__bd">
                                    <input class="weui-input" id="idfj" required name="blfj" value="${jbxx.blfj }"
                                        data-values="${jbxx.blfj_id }" readonly placeholder="请先选择分局">
                                </div>
                            </div>
                            <div class="weui-cell">
                                ...
                                <div class="weui-cells style1 weui-cells_form">
                                    ...
                                    <div class="imgshow imgshow_base1">
                                        <div>
                                            ...
                                            <p class="zhushi">
                                                请上传大中专学校招生录取通知书，照片大小不超过5兆。
                                            </p>
                                            <img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/lqtzs/lqtzs.jpg"
                                                alt="">
                                ...
                                <div class="weui-cells style2 weui-cells_form">
                                    ...
                                    <div class="imgshow imgshow_base2">
                                        <div>
                                            ...
                                            <p class="zhushi">
                                                请上传居民户口簿或集体户口登记卡,以居民户口簿为例，需上传户口簿正面，内页，登记卡，索引页等，照片大小不超过5兆。
                                            </p>
