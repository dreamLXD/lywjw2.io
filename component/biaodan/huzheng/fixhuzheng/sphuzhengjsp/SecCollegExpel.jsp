...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/SecCollegExpel.js"></script>
            ...
            <form action="#" method="post" id='signupForm'>
                <section>
                    ...
                    <div class="weui-cells weui-cells_form">
                        ...
                        <!-- 					<div class="weui-cell__bd"> -->
                        <!-- <%-- 						<input class="weui-input" required name="blrxb" id ="blrxb" disabled  value="${jbxx.blrxb }" placeholder=""> --%> -->
                        <!-- 					</div> -->
                        <!-- 				</div> -->
                        <!-- 				<div class="weui-cell"> -->
                        <!-- 					<div class="weui-cell__hd"><label class="weui-label">联系电话:</label></div> -->
                    ...
                    <c:forEach items="${photoes}" var="photoes">
                        <c:if test="${photoes.type_id == '2fb137e1e06347a3936a5bd6209e01b3' }">
                            <div class="weui-cells style1 weui-cells_form">
                                ...
                                <div class="imgshow imgshow_base1">
                                    <div>
                                        ...
                                        <p class="zhushi">
                                            请上传学校批准转退学、开除学籍文件，照片大小不超过5兆。
                                        </p>
                                        <img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/kcxjwj/kcxjwj.jpg" alt="">
                    ...
                    <c:forEach items="${photoes}" var="photoes">
                        <c:if test="${photoes.type_id == '9eee5d54aea94e289a55f769107ef540' }">
                            <div class="weui-cells style1 weui-cells_form">
                                <div class="container">
                                    <div class="weui_cells weui_cells_form">
                                        <div class="weui_cell">
