...
<head>
	...
	<script
		src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/EmployeTransfer.js"></script>
					...
					<section>
						...
						<div class="weui-cells weui-cells_form">
							...
							<div class="weui-cell">
								<div class="weui-cell__hd"><label class="weui-label">联系电话:</label></div>
								<div class="weui-cell__bd">
									<input class="weui-input" id="sbrlxdh" required name="sbrlxdh" placeholder="请输入电话号码"
										value="${jbxx.hztel }">
								</div>
							</div>
						</div>
						...
						<c:forEach items="${photoes}" var="photoes">
							<c:if test="${photoes.type_id == '17c51122ff784d19a9c05f82dc58bbd1' }">
								<div class="weui-cells weui-cells_form">
									<div class="container">
										<div class="weui_cells weui_cells_form">
											<div class="weui_cell">
									...
									<div class="imgshow imgshow_base3">
										<div>
											...
											<p class="zhushi">
												请上传组织、人社部门出具的调动函或录用通知书，注意照片大小不超过5兆。
												<br><br>
												<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/zzrsbmcjdddh/zzrsbmcjdddh.jpg"
													alt="">
											</p>
											<button>确定</button>
										</div>
						...
						<c:forEach items="${photoes}" var="photoes">
							<c:if test="${photoes.type_id == '80e4655125eb4d58bdd219b1220f078e' }">
								<div class="weui-cells   weui-cells_form">
									<div class="container">
										<div class="weui_cells weui_cells_form">
											<div class="weui_cell">
