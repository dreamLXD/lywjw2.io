...
<head>
	...
	<script
		src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/FemaleBabiesRegistration.js"></script>
					...
					<section>
						...
						<div class="weui-cells weui-cells_form">
							<div class="weui-cell">
								...
								<div class="weui-cell__bd">
									<input class="weui-input" type="text" name="fqname" value="${jbxx.fqname }" required
										placeholder="请输入姓名">
								</div>
							</div>
							<div class="weui-cell">
								...
								<div class="weui-cells weui-cells_form">
									...
									<div class="imgshow imgshow_base1">
										<div>
											...
											<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/jgz/jgz.jpg"
												alt="">
											<button>确定</button>
										</div>
									</div>
