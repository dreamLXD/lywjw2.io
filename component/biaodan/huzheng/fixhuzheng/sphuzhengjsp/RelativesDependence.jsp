...
<head>
	...
	<title>投靠其他亲属（限因父母死亡投靠其他监护人）</title>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/RelativesDependence.js"></script>
			...
			<div class="weui-cells    weui-cells_form">
				...
				<div class="imgshow imgshow_base4">
					<div>
						...
						<p class="zhushi">
							请上传指定或约定抚养权、监护权的材料，暂无示例图片，照片大小不超过5兆。
						</p>
						<button>确定</button>
					</div>
				</div>
