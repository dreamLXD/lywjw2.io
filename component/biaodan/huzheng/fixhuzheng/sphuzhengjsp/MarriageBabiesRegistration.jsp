...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/MarriageBabiesRegistration.js">
	</script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" required name="fqsfz"  value="${jbxx.fqsfz }" placeholder="请输入身份证">
					</div>
				</div>
				<div class="weui-cell">
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" data-toggle='date'  value="${jbxx.yecsrq }" 	 id="time" name="yecsrq" required
							placeholder="请选择日期">
					</div>
				</div>
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" id="resp" name="yeysqrgx"  value="${jbxx.yeysqrgx }" 	data-values="${jbxx.yeysqrgx_id }"   required placeholder="请选择关系">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">民族：</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" id="Nation" name="yemz" value="${jbxx.yemz }" 	data-values="${jbxx.yemz_id }"  required placeholder="请输入民族">
					</div>
				</div>
			</div>
			<h1>上传材料</h1>
			...
			<!--结婚证-->
<c:if test="${jbxx.bltype_id =='bed8beaa13ab4617808258f957c50e6e'}">
    <c:forEach items="${photoes}" var="photoes">
        <c:if test="${photoes.type_id == 'a69c7610096e401ca54e03e9adbf94ae' }">
            ...
            <!--离婚证-->
<c:if test="${jbxx.bltype_id =='1af5625eb7654b89ab3bffed3fddc501'}">
    <c:forEach items="${photoes}" var="photoes">
			...
			<div class="weui-cells style2 weui-cells_form">
				...
				<div class="imgshow imgshow_base5">
					<div>
						...
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/lhz/lhzOne.jpg" alt="">
						<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/lhz/lhzTwo.jpg" alt="">
						<button>确定</button>
					</div>
				</div>
            </div>
			...
			<div class="weui-cells style2 weui-cells_form">
					...
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">明确抚养关系的法律文书或协议书</div>
				...
				<div class="imgshow imgshow_base6">
					<div>
						...
						<p class="zhushi">
							请上传明确抚养关系的法律文书或协议书，暂无示例图片，照片大小不超过5兆。
						</p>
						<button>确定</button>
					</div>
				</div>
