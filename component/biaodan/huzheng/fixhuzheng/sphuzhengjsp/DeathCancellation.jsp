...
<head>
	...
	<script
		src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/DeathCancellation.js"></script>
			...
			<div id="tab2" class="weui-tab__bd-item">
				...
				<form action="#" method="post" id='signupForm'>
					<section>
						...
						<!-- 户主、监护人或者近亲属的居民户口簿 -->
						<c:forEach items="${photoes}" var="photoes">
							<c:if test="${photoes.type_id == 'bb818f571f2f4268b26c75b0a8c5cdb3' }">
								<div class="weui-cells  weui-cells_form">
									<div class="container">
										<div class="weui_cells weui_cells_form">
											<div class="weui_cell">
						...
						<!-- 居民身份证或其他有效身份证件 -->
						<c:forEach items="${photoes}" var="photoes">
							<c:if test="${photoes.type_id == 'd4acb096c1e24ea3837207db114cecb8' }">
								<div class="weui-cells  weui-cells_form">
									<div class="container">
										<div class="weui_cells weui_cells_form">
											<div class="weui_cell">
						...
						<c:if test="${jbxx.bltype_id =='6abf387eb84a4d888a5ccd7743d3f02f'}">
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == 'dfb5570e77a24fb7840bc29da6603160' }">
									<div class="weui-cells style1  weui-cells_form">
										...
										<div class="imgshow imgshow_base5">
											<div>
												...
												<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/swyxzm/swyxzm.jpg"
													alt="">
												<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/hhzm/hhzmOne.jpg"
													alt="">
												<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/hhzm/hhzmThree.jpg"
													alt="">
												<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/hhzm/hhzmTwo.jpg"
													alt="">
												<button>确定</button>
											</div>
										</div>
						...
						<c:if test="${jbxx.bltype_id =='f55eeb9745664739812639be0f0b9c95'}">
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == 'a781aecfe4504073bd99086cf7b41934' }">
						...
						<!--宣告失踪（死亡）判决书-->
						<c:if test="${jbxx.bltype_id =='a3203fa459c54ce190fa42f7de12e659'}">
							<c:forEach items="${photoes}" var="photoes">
