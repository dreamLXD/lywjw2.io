...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/ChangeID.js"></script>
								...
								<div class="weui-cells weui-cells_form">
												...
												<div class="weui_cell_bd weui_cell_primary">
													<div class="weui_uploader">
														<div class="weui_uploader_hd weui_cell">
															<div class="weui_cell_bd weui_cell_primary">本人或监护人申请
															</div>
															<i
									...
									<div class="imgshow imgshow_base1">
										<div>
											...
											<p class="zhushi">
												本人或监护人申请：第1页...
												<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/sfzbg/sfzbg.jpg"
													alt="">
											</p>
											<button>确定</button>
										</div>
