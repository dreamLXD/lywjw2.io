...
<head>
	...
	<title>随祖父母、外祖父母出生登记（父母双方属现役军人、在校学生或华侨）</title>
	...
	<script
		src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/GrandparentsBabiesRegistration.js">
		</script>
			...
			<div id="tab2" class="weui-tab__bd-item">
				...
				<form action="#" method="GET" id='signupForm'>
					<section>
								...
								<div class="weui-cells weui-cells_form">
										...
										<div class="weui_cells weui_cells_form">
											<div class="weui_cell">
												<div class="weui_cell_bd weui_cell_primary">
													<div class="weui_uploader">
														<div class="weui_uploader_hd weui_cell">
															<div class="weui_cell_bd weui_cell_primary">亲属关系</div>
															<i
									...
									<div class="imgshow imgshow_base5">
										<div>
											...
											<img src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/img/qsgxzm/qsgxzm.jpg"
												alt="">
											<button>确定</button>
										</div>
									</div>
						...
						<!-- 父母现役证件 -->
						<c:if test="${jbxx.bltype_id =='0b775ecde9d64c98b04890356fe290bd'}">
							<c:forEach items="${photoes}" var="photoes">
											...
											<div class="weui_cells weui_cells_form">
												<div class="weui_cell">
													<div class="weui_cell_bd weui_cell_primary">
														<div class="weui_uploader">
															<div class="weui_uploader_hd weui_cell">
																<div class="weui_cell_bd weui_cell_primary">父母现役证件</div>
																<i
						...
						<!-- 学生证件 -->
						<c:if test="${jbxx.bltype_id =='7ee72b60aea6486f898f03db30b2c34d'}">
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == '2a477dea708341fba34330279d48b7a8' }">
											...
											<div class="weui_cells weui_cells_form">
												<div class="weui_cell">
													<div class="weui_cell_bd weui_cell_primary">
														<div class="weui_uploader">
															<div class="weui_uploader_hd weui_cell">
																<div class="weui_cell_bd weui_cell_primary">学生证件</div>
																<i
						...
						<!-- 国外定居证、 -->
						<c:if test="${jbxx.bltype_id =='8eb39b11c88540869f9a8cec4df017ed'}">
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == '4e602912c18f440f983368d055c87f82' }">
											...
											<div class="weui_cells weui_cells_form">
												<div class="weui_cell">
													<div class="weui_cell_bd weui_cell_primary">
														<div class="weui_uploader">
															<div class="weui_uploader_hd weui_cell">
																<div class="weui_cell_bd weui_cell_primary">国外定居证</div>
																<i
											...
											<div class="weui_cells weui_cells_form">
												<div class="weui_cell">
													<div class="weui_cell_bd weui_cell_primary">
														<div class="weui_uploader">
															<div class="weui_uploader_hd weui_cell">
																<div class="weui_cell_bd weui_cell_primary">未取得外国国籍声明
																</div>
																<i
							...
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == '1b2ac258532b44e49100dfacbc64c4d2' }">
									<div class="weui-cells style3 weui-cells_form">
													...
													<div class="weui_cell_bd weui_cell_primary">
														<div class="weui_uploader">
															<div class="weui_uploader_hd weui_cell">
																...
																<i
																	class="weui-icon-warn weui-icon_msg-primary imgwarn img_i_base10"></i>
															</div>
															<div class="weui_uploader_bd">
																<ul class="weui_uploader_files ten">
																	<c:forEach items="${photoes.zplist}"
																		var="photoesdata">
																		<li class="weui_uploader_file weui_uploader_status"
																			style="background-image:url('${photoesdata.zplj} ')">
																...
																<div class="weui_uploader_input_wrp">
																	<input class="weui_uploader_input js_file10"
																		type="file" name="img" accept="image/*"
																		multiple></div>
															</div>
														</div>
										...
										<div class="imgshow imgshow_base10">
											<div>
												<p class="title"> 详细介绍 </p>
												<!--<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/shili.jpg" alt="">-->
												<p class="zhushi">
