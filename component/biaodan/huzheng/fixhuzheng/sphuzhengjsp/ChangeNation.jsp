...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/ChangeNation.js"></script>
				...
				<form action="#" method="post" id='signupForm'>
					<section>
						...
						<div class="weui-cells weui-cells_form">
							...
							<div class="weui-cell">
								<div class="weui-cell__hd"><label class="weui-label">变更后民族:</label></div>
								<div class="weui-cell__bd">
									<input class="weui-input" id="bghnr" required name="bghnr" value="${jbxx.bghnr }"
										data-values="${jbxx.bghnr_id }" placeholder="请选择变更后民族">
								</div>
							</div>
						...
						<c:forEach items="${photoes}" var="photoes">
							<c:if test="${photoes.type_id == 'cdf7eb4d3ae14aedb66df599ba00bd0b' }">
								<div class="weui-cells style2 weui-cells_form">
									<div class="container">
										<div class="weui_cells weui_cells_form">
											<div class="weui_cell">
									...
									<div class="imgshow imgshow_base3">
										<div>
											...
											<p class="zhushi">
												请上传变更民族的民族事务部门的审批意见，注意照片大小不超过5兆。
											</p>
											<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/bggzmz/bggzmz.jpg"
												alt="">
