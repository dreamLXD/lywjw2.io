...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/SoldierSettle.js"></script>
					...
					<section>
						...
						<div class="weui-cells weui-cells_form">
							...
							<div class="weui-cell">
								...
								<div class="weui-cell__bd">
									<input class="weui-input" id="btkryhzgx" required value="${jbxx.btkryhzgx }"
										data-values="${jbxx.btkryhzgx_id }" name="btkryhzgx" placeholder="请选择关系">
								</div>
							</div>
						</div>
								...
								<div class="weui-cells weui-cells_form">
									...
									<div class="imgshow imgshow_base1">
										<div>
											...
											<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/jdzygblh/dwzm.jpg"
												alt="">
								...
								<div class="weui-cells  weui-cells_form">
									...
									<div class="imgshow imgshow_base4">
										<div>
											...
											<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/twz_jsx_djb/twzwm.jpg"
												alt="">
