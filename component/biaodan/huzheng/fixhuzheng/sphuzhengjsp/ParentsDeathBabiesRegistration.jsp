...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/ParentsDeathBabiesRegistration.js">
	</script>
...
<!-- 				</div> -->
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" name="syname" value="${jbxx.syname }"	 required placeholder="请输入姓名">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">公民身份证号码：</label></div>
					<div class="weui-cell__bd">
						<input class="weui-input" required name="sysfz"  value="${jbxx.sysfz }" placeholder="请输入身份证">
					</div>
				</div>
				<div class="weui-cell">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" name="mqsfz" required value="${jbxx.mqsfz }"   placeholder="请输入身份证">
					</div>
				</div>
			</div>
			<h1>新生儿信息</h1>
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input class="weui-input" type="text" value="${jbxx.yecsrq }" data-toggle='date' id="time" name="yecsrq" required
							placeholder="请选择日期">
					</div>
				</div>
            ...
            <!--父母死亡医学证明-->
                <c:forEach items="${photoes}" var="photoes">
                    <c:if test="${photoes.type_id == '441f520ab5ac4c728cbf50dabf5c5f72' }">
			<div class="weui-cells  weui-cells_form">
				<div class="container">
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
            ...
            <!-- 制定或约定抚养权 -->
            <c:forEach items="${photoes}" var="photoes">
                <c:if test="${photoes.type_id == '62f8e9f7a6e247d0bd706969fe9a2338' }">
			<div class="weui-cells weui-cells_form">
				<div class="container">
					<div class="weui_cells weui_cells_form">
						<div class="weui_cell">
            ...
            <!-- 监护权的材料 -->
            <c:forEach items="${photoes}" var="photoes">
                <c:if test="${photoes.type_id == 'fa27ea8ecb9a4b84a9dea58a83a8c72c' }">
