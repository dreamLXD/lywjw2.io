...
<head>
	...
	<script
		src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/CivilServiceSettle.js"></script>
					...
					<div class="weui-cells weui-cells_form">
						<div class="weui-cell">
							...
							<div class="weui-cell__bd padr_40">
								<input class="weui-input" required name="tkr_name${ status.index + 100}"
									value="${idxStatus.tkrxm}" placeholder="请输入姓名">
							</div>
						</div>
						<div class="weui-cell">
							<div class="weui-cell__hd"><label class="weui-label">公民身份证号码：</label></div>
							<div class="weui-cell__bd">
								<input class="weui-input" required name="tkr_sfz${ status.index +100}"
									value="${idxStatus.tkrsfz}" placeholder="请输入身份证号码">
							</div>
						</div>
						<div class="weui-cell">
							<div class="weui-cell__hd"><label class="weui-label">联系电话：</label></div>
							<div class="weui-cell__bd">
								<input class="weui-input" required name="tkr_lxdh${ status.index + 100}"
						...
						<div class="weui-cell">
							...
							<div class="weui-cell__bd">
								<input class="weui-input" id="tkr_ysqrgx${ status.index + 100}" required
									name="tkr_ysqrgx${ status.index + 100}" value="${idxStatus.ysqrgx}"
									data-values="${idxStatus.ysqrgx_id}" placeholder="请选择关系">
							</div>
						</div>
							...
							<div class="weui-cells weui-cells_form">
											...
											<div class="weui_cell_bd weui_cell_primary">
												<div class="weui_uploader">
													<div class="weui_uploader_hd weui_cell">
														<div class="weui_cell_bd weui_cell_primary">落户介绍信（指标卡）
														</div>
								...
								<div class="imgshow imgshow_base1">
									<div>
										...
										<p class="zhushi">
											请上传落户介绍信（指标卡），照片大小不超过5兆。
										</p>
										<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/lhjsx/lhjsx.jpg"
											alt="">
										<button>确定</button>
									</div>
								</div>
									...
									<div class="weui_cells weui_cells_form">
										<div class="weui_cell">
											<div class="weui_cell_bd weui_cell_primary">
												<div class="weui_uploader">
													<div class="weui_uploader_hd weui_cell">
														<div class="weui_cell_bd weui_cell_primary">接收证明</div>
							...
							<div class="weui-cells  weui-cells_form">
								...
								<div class="imgshow imgshow_base3">
									<div>
										...
										<p class="zhushi">
											请上传居民身份证或军人公民身份号码登记表复印件，保障照片清晰度（图片大小不超过5兆）
										</p>
							...
							<div class="weui-cells  weui-cells_form">
								...
								<div class="imgshow imgshow_base4">
									<div>
										<p class="title"> 实例图片 </p>
										<p class="zhushi">
											请上传退役证件，并保障照片清晰度（图片大小不超过5兆）
										</p>
										<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/twz/twz.jpg" alt="">
										<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/twz/twz1.jpg" alt="">
										<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/twz/twz2.jpg" alt="">
										<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/wjwhztstp/twz/twz3.jpg" alt="">
										<button>确定</button>
									</div>
								</div>
							</div>
