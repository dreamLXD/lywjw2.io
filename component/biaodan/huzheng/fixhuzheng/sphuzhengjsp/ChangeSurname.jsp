...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/huzheng/fixhuzheng/js/ChangeSurname.js"></script>
					...
					<section>
						...
						<div class="weui-cells weui-cells_form">
							...
							<div class="weui-cell">
								<div class="weui-cell__hd"><label class="weui-label">姓名:</label></div>
								<div class="weui-cell__bd">
									<input class="weui-input" type="text" name="sqrxm" value="${jbxx.sqrxm }" required
										placeholder="请输入姓名">
								</div>
							</div>
							<div class="weui-cell">
							...
							<div class="weui-cell">
								<div class="weui-cell__hd"><label class="weui-label">变更姓氏:</label></div>
								<div class="weui-cell__bd">
						...
						<!-- 生父母协商同意材料（限未成年生子女变更姓氏） -->
						<c:if test="${jbxx.bltype_id =='becb286bb6884b4ea125357e25be7928'}">
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == '8f578ae18b224f2392c73e762d49e6f6' }">
									<div class="weui-cells style1 weui-cells_form">
										<div class="container">
											<div class="weui_cells weui_cells_form">
												<div class="weui_cell">
										...
										<div class="imgshow imgshow_base4">
											<div>
												...
												<p class="zhushi">
													请上传生父母协商同意材料（限未成年生子女变更姓氏），注意照片大小不超过5兆。
												</p>
												<button>确定</button>
											</div>
										</div>
						...
						<!--4.收养证或解除收养关系证明、-->
						<c:if test="${jbxx.bltype_id =='f3922bd028cc48c58f54167d16f09161'}">
							<c:forEach items="${photoes}" var="photoes">
						...
						<!-- 父母共同申请（限被收养的未成年子女变更姓氏） -->
						<c:if test="${jbxx.bltype_id =='f3922bd028cc48c58f54167d16f09161'}">
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == '7bf52be95c2a41b0ab86c6ab10e863a2' }">
									<div class="weui-cells style2 weui-cells_form">
										<div class="container">
											<div class="weui_cells weui_cells_form">
												<div class="weui_cell">
										...
										<div class="imgshow imgshow_base6">
											<div>
												...
												<!--<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/shili.jpg" alt="">-->
												<p class="zhushi">
													请上传父母共同申请（限被收养的未成年子女变更姓氏），暂无示例图片。注意照片大小不超过5兆。
												</p>
												<button>确定</button>
											</div>
										</div>
						...
						<!--5.选取其他直系长辈血亲姓氏的关系证明（限选取其他直系长辈血亲姓氏）-->
						<c:if test="${jbxx.bltype_id =='5e78d84bf45a41fbb72531ae6c621806'}">
							<c:forEach items="${photoes}" var="photoes">
								<c:if test="${photoes.type_id == 'd30a055b28b845e5b4e40710e327a551' }">
									<div class="weui-cells style3 weui-cells_form">
												...
												<div class="weui_cell">
													<div class="weui_cell_bd weui_cell_primary">
														<div class="weui_uploader">
															<div class="weui_uploader_hd weui_cell">
																<div class="weui_cell_bd weui_cell_primary">
																	选取其他直系长辈血亲姓氏的关系证明（限选取其他直系长辈血亲姓氏）
																</div>
																<i
										...
										<div class="imgshow imgshow_base7">
											<div>
												...
												<!--<img src="<%=basePath%>webpage/lywjw/lyswjwwx/img/shili/shili.jpg" alt="">-->
												<p class="zhushi">
													请选取其他直系长辈血亲姓氏的关系证明（限选取其他直系长辈血亲姓氏），暂无示例图片。照片大小不超过5兆。
												</p>
												<button>确定</button>
											</div>
										</div>
