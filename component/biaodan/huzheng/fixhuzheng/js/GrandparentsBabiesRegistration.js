$(function () {
    ...
    // $('.style3').css('display', 'none')
            ...
            //     items: [{
            //             title: "父母现役军官",
            //             value: "0b775ecde9d64c98b04890356fe290bd",
            //         },
            //         {
            //             title: "父母在校学生",
            //             value: "7ee72b60aea6486f898f03db30b2c34d",
            //         }, {
            //             title: "父母是华侨",
            //             value: "8eb39b11c88540869f9a8cec4df017ed",
            //         }
            //     ],
            //     onClose: function () {
            //         $('.style1').css('display', 'none')
            ...
            //         $('.nine').html('')
            //         $('.ten').html('')
            //         if ($('#style').data('values') == '0b775ecde9d64c98b04890356fe290bd') {
            //             $('.style1').css('display', 'block')
            //         } else if ($('#style').data('values') == '7ee72b60aea6486f898f03db30b2c34d') {
...
$(function () {
    ...
    $('footer button').on('click', function (e) {
        ...
        arr.forEach((item) => {
            ...
            if (item.name == 'blrxb') {
                obj[item.name] = $('#blrxb').data('values')
            }
        ...
        filestr('arr_file6', '.six', 'sixfile', 'f70df249ea514d21aac755751bdb2f5a')
        filestr('arr_file7', '.seven', 'sevenfile', '2a477dea708341fba34330279d48b7a8')
        filestr('arr_file8', '.eight', 'eightfile', '4e602912c18f440f983368d055c87f82') 
        filestr('arr_file9', '.nine', 'ninefile', '2c68cc1decca44ebb92da5cd2557931e')
        filestr('arr_file10', '.ten', 'tenfile', '1b2ac258532b44e49100dfacbc64c4d2')

        console.log(obj)

        obj.blyw = '4dce827709ea4668a3320f906b721be0'

        if (obj.bltype === '0b775ecde9d64c98b04890356fe290bd') {
            img_reg(obj, ['onefile', 'twofile', 'threefile', 'fourfile', 'fivefile', 'sixfile'])
        } else if (obj.bltype === '7ee72b60aea6486f898f03db30b2c34d') {
            img_reg(obj, ['onefile', 'twofile', 'threefile', 'fourfile', 'fivefile', 'sevenfile'])
        }else if (obj.bltype === '8eb39b11c88540869f9a8cec4df017ed') {
            img_reg(obj, ['onefile', 'twofile', 'threefile', 'fourfile', 'fivefile', 'eightfile', 'ninefile', 'tenfile'])
        }
