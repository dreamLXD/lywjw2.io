...
$(function () {
    ...
    $('footer button').on('click', function (e) {
        ...
        arr.forEach((item) => {
            ...
            if (item.name == 'qtryxb') {
                obj[item.name] = $('#qtryxb').data('values')
            }
        ...
        filestr('arr_file3', '.three', 'threefile', 'cb05553c39714fc283607954e90d3927')
        filestr('arr_file4', '.four', 'fourfile', '1b736d5515224fde97a6534f1a7a7793')


        console.log(obj)

        obj.blyw = '3540dee08a8f44fbaf56dce32a500a1a'
