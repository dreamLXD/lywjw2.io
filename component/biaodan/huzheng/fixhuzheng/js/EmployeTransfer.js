...
$(function () {
	...
	$('footer button').on('click', function (e) {
		...
		filestr('arr_file3', '.three', 'threefile', '17c51122ff784d19a9c05f82dc58bbd1')
		filestr('arr_file4', '.four', 'fourfile', '80e4655125eb4d58bdd219b1220f078e')
		filestr('arr_file5', '.five', 'fivefile','2352399efbf04e1f94ccfcd9a54a9596')
		filestr('arr_file6', '.six', 'sixfile', ' c6c3d461be5244deb5e4c59a5e2542fa')
		filestr('arr_file7', '.seven', 'sevenfile','00049911e5464455bafe361fca6781a7')

		console.log(obj)

		obj.blyw = '96d321b7248449a0a1f7d8b00e7142db'
