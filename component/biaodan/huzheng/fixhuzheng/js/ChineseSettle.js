...
$(function() {
            ...
            <div class="weui-cells weui-cells_form">
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            <input class="weui-input" required name="sqr_sfz${num}" placeholder="请输入身份证号码">
                        </div>
                    </div>
                    <div class="weui-cell">
    ...
    $('footer button').on('click', function(e) {
        ...
        filestr('arr_file1', '.one', 'onefile', 'ec8e38adb78f43309cd47c8f71aefa59')
        filestr('arr_file2', '.two', 'twofile', '2352399efbf04e1f94ccfcd9a54a9596')
        filestr('arr_file3', '.three', 'threefile', 'f4e05d3d86fb49af9202dc7798414d07')
        filestr('arr_file4', '.four', 'fourfile', 'c6c3d461be5244deb5e4c59a5e2542fa')
        filestr('arr_file5', '.five', 'fivefile', '2482aad614b24bd48d3f7a92c7cb405c')

        console.log(obj)

        obj.blyw = '3518a7658601499eaeca5b314cb99a12'
