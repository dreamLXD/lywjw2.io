...
$(function() {
    ...
    $('footer button').on('click', function(e) {
        ...
        filestr('arr_file3', '.three', 'threefile', '441f520ab5ac4c728cbf50dabf5c5f72')
        filestr('arr_file4', '.four', 'fourfile', '73672ee6df1b4982bfd204e31413d239')


        console.log(obj)

        obj.blyw = '7119d353ce454e9eb83f9efb2f78bffa'
