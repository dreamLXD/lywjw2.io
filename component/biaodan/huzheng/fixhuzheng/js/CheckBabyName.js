    ...
    $(function () {
        ...
        $.post(base_path+"/wxzd/Nation", data, function (msg) {
            ...
            for(let item in mzobj){
                let obj={}
                obj={title:item,value:mzobj[item]};
                 console.log(obj)
                mzarr.push(obj)
            }
            $('#Nation').select({
    ...
    $(function () {
        ...
        $('footer button').on('click', function (e) {
            ...
            arr.forEach((item) => {
                ...
                if (item.name == 'yesex') {
                    obj[item.name] = $('#yesex').data('values')
                }
            ...
            filestr('arr_file1', '.one', 'onefile', 'f194750454fb474c8e65628e5d604064')


            console.log(obj)

            obj.blyw = 'bc352ea0979349f89d19c6e565c9ac32'
