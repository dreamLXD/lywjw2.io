...
$(function () {
	...
	$('footer button').on('click', function (e) {
		...
		filestr('arr_file2', '.two', 'twofile', '33ada1e97e0348e6bdeac891b72da3c8')
		filestr('arr_file3', '.three', 'threefile', '09f86e6af71c48609e30f167e8b871e1') 
		filestr('arr_file4', '.four', 'fourfile','2352399efbf04e1f94ccfcd9a54a9596')
		filestr('arr_file5', '.five', 'fivefile','00049911e5464455bafe361fca6781a7')
		// filestr('arr_file5', '.five', 'fivefile')
		console.log(obj)

		obj.blyw = '8ff0b51acf884a2ca663808df06e8a1a'
