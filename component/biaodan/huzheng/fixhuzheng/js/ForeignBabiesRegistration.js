...
$(function () {
    ...
    $('form').submit()
        ...
        filestr('arr_file5', '.five', 'fivefile', '7319712d3e0449c8b348d53aaf4f69a8')
        filestr('arr_file6', '.six', 'sixfile', '2c68cc1decca44ebb92da5cd2557931e')
        filestr('arr_file7', '.seven', 'sevenfile', '1b2ac258532b44e49100dfacbc64c4d2')

        console.log(obj)

        obj.blyw = 'ecd3c052012f4fedaf3ef07a4fd8757f'

        img_reg(obj, ['onefile', 'twofile','threefile','fourfile','fivefile','sixfile','sevenfile'])
