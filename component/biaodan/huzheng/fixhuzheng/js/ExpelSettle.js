...
$(function () {
    ...
    $('footer button').on('click', function (e) {
        ...
        filestr('arr_file2', '.two', 'twofile', '7a45d6ab9fbf45f08129fd7b7729d6b3')
        filestr('arr_file3', '.three', 'threefile', '48fb29abf5374017a1650fedb110ded2')
        filestr('arr_file4', '.four', 'fourfile', 'fd6d2b9ccba84ccfbf6b54c56998d3cd')


        console.log(obj)

        obj.blyw = '7a2c2c6a4db64e6da3c43a418bdb8197'
