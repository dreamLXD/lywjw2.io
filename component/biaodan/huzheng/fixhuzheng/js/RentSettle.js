$(function() {
    ...
    var bltype_id = $('#bltype_id').val();
    console.log(bltype_id)

    if(bltype_id == '22b1c3879f2e491780cf6c66e0eb03e4'){
        urlval = "1";
    }else{
        urlval = "2";
    }
...
$(function() {
    ...
    $('footer button').on('click', function(e) {
        ...
        filestr('arr_file3', '.three', 'threefile', 'e5dc025922c645399de8b50cdddbeb1c')
        filestr('arr_file4', '.four', 'fourfile', '229483c5ba26490b8cc69e7b7091930b')
        filestr('arr_file5', '.five', 'fivefile', '6b3b65d28d5345eaa5a7e147199f20ed')
        filestr('arr_file6', '.six', 'sixfile', '7f42c080ed20468399c7b0a4ce5b1406')
        ...
        obj.blyw = '54a6536dac164b13b3c0f3baf0b07a8f'
