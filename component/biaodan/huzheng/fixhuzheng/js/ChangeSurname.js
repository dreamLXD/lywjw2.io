$(function () {
	...
	// $('.style3').css('display', 'none')
			...
			// 	items: [{
			// 			title: "限未成年生子女变更姓氏",
			// 			value: "becb286bb6884b4ea125357e25be7928",
			// 		},
			// 		{
			// 			title: "限被收养的未成年子女",
			// 			value: "f3922bd028cc48c58f54167d16f09161",
			// 		},
			// 		{
			// 			title: "限选取其他直系长辈血亲",
			// 			value: "5e78d84bf45a41fbb72531ae6c621806",
			// 		}
			...
			// 		$('.six').html('')
			// 		$('.seven').html('')
			// 		if ($('#style').data('values') == 'becb286bb6884b4ea125357e25be7928') {
			// 			$('.style1').css('display', 'block')
			// 		} else if ($('#style').data('values') == 'f3922bd028cc48c58f54167d16f09161') {
...
$(function () {
	...
	$('footer button').on('click', function (e) {
		...
		filestr('arr_file4', '.four', 'fourfile', '8f578ae18b224f2392c73e762d49e6f6')
		filestr('arr_file5', '.five', 'fivefile', '9ea02e208fb64d6ba89f2a8f5740d964')
		filestr('arr_file6', '.six', 'sixfile', '7bf52be95c2a41b0ab86c6ab10e863a2')
		filestr('arr_file7', '.seven', 'sevenfile', 'd30a055b28b845e5b4e40710e327a551')

		console.log(obj)


		obj.blyw = '979a65f3824d44cfbfd7e81f41f1f882'

        if (obj.bltype === 'becb286bb6884b4ea125357e25be7928') {
            img_reg(obj, ['onefile', 'twofile', 'threefile', 'fourfile'])
        } else if (obj.bltype === 'f3922bd028cc48c58f54167d16f09161') {
            img_reg(obj, ['onefile', 'twofile', 'fivefile', 'sixfile'])
        } else if (obj.bltype === '5e78d84bf45a41fbb72531ae6c621806') {
