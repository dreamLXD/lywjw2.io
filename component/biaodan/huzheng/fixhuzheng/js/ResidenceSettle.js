$(function() {
    ...
    //     items: [{
    //             title: "有房产证或不动产证",
    //             value: "f90a4748946545d58a5699c971f8776f",
    //         },
    //         {
    //             title: "还未获得房产证但有购房合同与购房发票的",
    //             value: "58def4f3d56142c49509a6e91dc276ef",
    //         },
    //         {
    //             title: "已有房产证但无法提供的",
    //             value: "a56b87cac8ea4a5f924c157950ef8306",
    //         }
    //     ],
    //     onClose: function() {
    //         $('.style1').css('display', 'none')
    ...
    //         if ($('#style').data('values') == 'f90a4748946545d58a5699c971f8776f') {
    //             $('.style1').css('display', 'block')
    //         } else if ($('#style').data('values') == '58def4f3d56142c49509a6e91dc276ef') {
    //             $('.style2').css('display', 'block')
    //         } else if ($('#style').data('values') == 'a56b87cac8ea4a5f924c157950ef8306') {
    //             $('.style3').css('display', 'block')
    //         } else if ($('#style').data('values') == '4') {
...
$(function() {
    ...
    $('footer button').on('click', function(e) {
        ...
        filestr('arr_file3', '.three', 'threefile', '0e378c8d801a4c6299b5b1734598f29f') //房屋产权证或不动产证或房管部门出具的房屋权属状况信息
        filestr('arr_file4', '.four', 'fourfile', '752f151951a344dda975a524dcf6598d') //购房合同与购房发票
        filestr('arr_file5', '.five', 'fivefile', 'd50db82892564b30bb5c907af51d549f') //村居、单位出具房产证明和居住证明，由派出所提供平面图，社区民警调查核实
        ...
        filestr('arr_file8', '.eight', 'eightfile', '5c5afe5bc1714b35a60943e97ad8282f')
        filestr('arr_file9', '.nine', 'ninefile', '3e17bb0cf5724ceab4ae10cb92e71e90')
        ...
        obj.blyw = '4328d3616f3e4351a11cc82da6b7d0d9'

        if (obj.bltype === 'f90a4748946545d58a5699c971f8776f') {
            img_reg(obj, ['onefile', 'twofile', 'threefile', 'sixfile', 'sevenfile'])
        } else if (obj.bltype === '58def4f3d56142c49509a6e91dc276ef') {
            img_reg(obj, ['onefile', 'twofile', 'fourfile', 'sixfile', 'sevenfile'])
        } else if (obj.bltype === 'a56b87cac8ea4a5f924c157950ef8306') {
            img_reg(obj, ['onefile', 'twofile', 'fivefile', 'eightfile', 'ninefile'])
        }
            ...
            <div class="weui-cells weui-cells_form">
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd padr_40">
                            <input class="weui-input" required name="sqr_name${num}" placeholder="请输入姓名">
                        </div>
                    </div>
                    <div class="weui-cell">
                        <div class="weui-cell__hd"><label class="weui-label">公民身份证号码：</label></div>
                        <div class="weui-cell__bd">
                            <input class="weui-input" required name="sqr_name${num}" placeholder="请输入身份证号码">
                        </div>
                    </div>
                    <div class="weui-cell">
                        <div class="weui-cell__hd"><label class="weui-label">联系电话：</label></div>
                        <div class="weui-cell__bd">
                            <input class="weui-input" required name="sqr_lxdh${num}" placeholder="请输入号码">
                        </div>
                    </div>
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            <input class="weui-input" id="sqr_ysqrgx${num}" required name="sqr_ysqrgx${num}" placeholder="请选择关系">
                        </div>
                    </div>
