...
<head>
	...
	<script src="<%=basePath%>webpage/lywjw/lyswjwwx/component/biaodan/supervise/js/FamilyAppointment.js"></script>
	...
	<form action="javascript:;" method="post" id="signupForm">
		<section>
				...
				<div class="weui-cells weui-cells_form">
					...
					<div class="weui-cell">
						<div class="weui-cell__hd"><label class="weui-label">家属与被会见人员关系:</label></div>
						<div class="weui-cell__bd">
							<input class="weui-input" id="RelationsDetainees" required name="RelationsDetainees" placeholder="请输入家属与被会见人员关系">
						</div>
					</div>
				...
				<div class="weui-cells weui-cells_form">
					<div class="weui-cell">
						<div class="weui-cell__hd"><label class="weui-label">家属姓名:</label></div>
						<div class="weui-cell__bd">
							<input class="weui-input" name="FamilyName" placeholder="请输入姓名" >
						</div>
					</div>
					<div class="weui-cell">
						<div class="weui-cell__hd"><label class="weui-label">家属身份证号:</label></div>
						<div class="weui-cell__bd">
							<input class="weui-input" required name="FamilyCard" placeholder="请输入身份证号码">
						</div>
					</div>
					<div class="weui-cell">
						<div class="weui-cell__hd"><label class="weui-label">家属联系电话:</label></div>
						<div class="weui-cell__bd">
							<input class="weui-input" required name="TelephoneFamily"  placeholder="请输入联系电话">
						</div>
					</div>					
					<div class="weui-cell">
							...
							<div class="weui_cell_bd weui_cell_primary">
								<div class="weui_uploader">
									<div class="weui_uploader_hd weui_cell">
										<div class="weui_cell_bd weui_cell_primary">预备</div>
